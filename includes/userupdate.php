...
<?php 
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['update'])) {
        if (empty($_POST['old-password']) || empty($_POST['pswd1']) || empty($_POST['pswd2'])) {
        ...
        } else if(isset($_POST['old-password']) && isset($_POST['pswd1']) && isset($_POST['pswd2'])) {
            $change_password = $_POST['pswd1'];
...
function UpdateSuccess() {
    ...
    window.location.href = '../dashboard.php?p=settings';
});
}
...
// window.location.href='../../dashboard.php?p=categories';
</script>
